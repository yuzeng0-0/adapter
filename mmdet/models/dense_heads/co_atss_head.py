...
class CoATSSHead(AnchorHead):
    ...
    def _get_target_single(self,
        ...
        pred_instance.priors =anchors
        
        assign_result = self.assigner.assign(pred_instance, num_level_anchors_inside,gt_instance)

        sampling_result = self.sampler.sample(assign_result, pred_instance,
                                              gt_instance)
