...
# 写dinov2 prefix时，新加一个MultiheadAttentionPrefix的类
class MultiheadAttentionPrefix(BaseModule):
    """Multi-head Attention Module.
    ...
    def __init__(self,
                 ...
                 layer_scale_init_value=0.,
                 init_cfg=None):
        super(MultiheadAttentionPrefix, self).__init__(init_cfg=init_cfg)
