...
class Dinov2VisionTransformer_Conv_Lora(BaseModule):
    """Vision Transformer.
    ...
    def __init__(self,
                 ...
                 pre_norm=False,
                 init_cfg=None):
        super(Dinov2VisionTransformer_Conv_Lora, self).__init__(init_cfg)
    ...
    def init_weights(self):
        super(Dinov2VisionTransformer_Conv_Lora, self).init_weights()
