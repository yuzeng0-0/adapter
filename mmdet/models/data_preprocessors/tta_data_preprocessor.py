...
class TTADetDataPreprocessor(ImgDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> dict:
        ...
        for idx in range(len(data['inputs'])):   
            new_data['inputs'].append(data['inputs'][idx][0])
            new_data['data_samples'].append(data['data_samples'][idx][0])
        
        batch_pad_shape = self._get_pad_shape(new_data)
        data = super().forward(data=new_data, training=training)
