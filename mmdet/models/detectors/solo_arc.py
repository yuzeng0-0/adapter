...
from mmdet.models.adapters.ARC import (ARC_adapter,sam_transformer_forward_arc,forward_sam_block_arc,swin_layers_forward_arc,swin_transformer_forward_arc,
                                       dinov2_transformer_forward_arc,forward_dinov2_layer_arc,forward_eva02_layer_arc,eva02_transformer_forward_arc)
import torch
import mmengine

@MODELS.register_module()
class SOLOARC(SingleStageInstanceSegmentor):
