...
import re
from mmdet.models.adapters.lora_fft import LoRAFFT
from mmengine.runner.checkpoint import CheckpointLoader
from copy import deepcopy


@MODELS.register_module()
class ATSSLoraFFT(SingleStageDetector):
    ...
    def _replace_module(self, tuning_module,full_module_name: str, _child_module: nn.Module,
        ...
        target_module = LoRAFFT(_child_module,alpha, rank, drop_rate).to(_child_module.weight.device)
