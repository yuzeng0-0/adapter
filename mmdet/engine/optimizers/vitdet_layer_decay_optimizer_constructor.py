...
class VitDetLayerDecayOptimizerConstructor(DefaultOptimWrapperConstructor):
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        print("Build VitDetLayerDecayOptimizerConstructor %f - %d" % (layer_decay_rate, num_layers))
