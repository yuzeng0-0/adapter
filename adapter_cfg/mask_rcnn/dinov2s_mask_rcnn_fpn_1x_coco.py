...
model = dict(
   ...
   backbone=dict(
        ...
        # checkpoint = '/home/chenz/code/PEFT/checkpoints/vit-small-p14_dinov2-pre_3rdparty_20230426-5641ca5a.pth',
        arch='dinov2-small',
        img_size=518,
        patch_size=14,
        layer_scale_init_value=1e-5,
        out_type = 'featmap',
        init_cfg=dict(type='Pretrained', checkpoint='checkpoints/changed_vit-small-p14to16_dinov2-pre_3rdparty_20230426-5641ca5a.pth')
    ),
